...
class EncryptionService {
    ...
    async encryptDocument(buffer) {
        try {
            ...
            const key = crypto_1.default.randomBytes(32); // 256 bits
            const iv = crypto_1.default.randomBytes(12); // 96 bits for GCM
            // Create cipher
     ...
     */
    async decryptDocument(encryptedData, keyHex, ivHex, authTagHex) {
        try {
     ...
     */
    generateAccessConditions(recipientAddress, tokenId) {
        const baseCondition = {
